...
// Import Item, Account, UnitOfMeasure, ItemVariant, Location if they are defined
...
export class SalesCreditMemoLine {
  ...
  /** Foreign Key: Sales Credit Memo ID */
  ...
  /** Many-to-One relationship with SalesCreditMemo */
  @ManyToOne(
    () => SalesCreditMemo,
    (salesCreditMemo) => salesCreditMemo.salesCreditMemoLines,
    { nullable: true }
  )
