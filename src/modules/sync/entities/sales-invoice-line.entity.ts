...
import { SalesInvoice } from './sales-invoice.entity';
  ...
  export class SalesInvoiceLine {
    ...
    /** Foreign Key: Reference to SalesInvoice */
    @Column({ name: 'sales_invoice_id', type: 'char', length: 36 })
    salesInvoiceId: string;
  
    @ManyToOne(() => SalesInvoice, (salesInvoice) => salesInvoice.salesInvoiceLines)
